<p align="center">
  <img src="images/banner.png" alt="NotiPet — 맥에 오는 모든 알림을 귀여운 펫이 말풍선으로 알려 줘요">
</p>
...
<p align="center">
  ...
  <a href="https://notipet.sanghak.kr/"><img src="https://img.shields.io/badge/%ED%99%88%ED%8E%98%EC%9D%B4%EC%A7%80-notipet.sanghak.kr-A36BF2?style=for-the-badge" alt="홈페이지 notipet.sanghak.kr"></a>
</p>

<br>

<p align="center">
  <img src="images/demo.gif" width="720" alt="펫이 걷다가 알림이 오자 뛰어올라 말풍선을 띄우는 모습">
</p>

<p align="center">
  펫이 화면 아래를 걸어 다니다가, 알림이 오면 <b>깜짝 뛰어올라 말풍선으로 알려 줘요.</b><br>
  말풍선을 누르면 알림을 보낸 앱이 바로 열려요.
</p>

<br>

<img src="images/features.png" alt="모든 앱 알림 · 펫 10종 · 크기와 색 조정 · 누르면 바로 그 앱">
...
> 🔑 **2.0부터 유료예요.** 처음 열면 키 입력 창이 떠요. [notipet.sanghak.kr](https://notipet.sanghak.kr/#buy)에서 **이메일을 남겨 구매 신청**하면, 그 이메일 전용 키를 보내 드려요. 앱에는 이메일과 키를 함께 넣어요.<br>
...
<img src="images/play.png" alt="쓰다듬기, 들어서 옮기기, 말풍선 닫기, 낮잠">
...
<p align="center">
  <img src="images/settings-framed.png" width="600" alt="펫 설정 창">
</p>
...
<details>
<summary><b>메뉴바 🐾 메뉴 전체 설명 펼치기</b></summary>
...
<br>
<b>2.0부터</b> 유료라서 키가 있어야 실행돼요. <a href="https://notipet.sanghak.kr/#buy">notipet.sanghak.kr</a>에서 이메일을 남겨 구매 신청하면 그 이메일 전용 키를 보내 드려요. 키 입력 창의 <b>구매하기</b> 버튼을 눌러도 돼요. 앱에는 <b>이메일과 키를 함께</b> 넣고, 한 번 넣으면 다시 묻지 않아요.<br>
...
<details>
<summary><b>권한을 켰는데도 "권한이 필요해요"라고 해요</b></summary>
<br>
...
<p align="center">
  <img src="images/icon.png" width="64" alt=""><br>
  <b>NotiPet</b> · macOS 13 이상 · Apple 실리콘 / Intel<br>
